        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HenkiloNro = table.Column<string>(nullable: false),
                    Etunimi = table.Column<string>(maxLength: 50, nullable: false),
                    ToinenNimi = table.Column<string>(maxLength: 50, nullable: true),
                    Sukunimi = table.Column<string>(maxLength: 50, nullable: false),
                    Kokonimi = table.Column<string>(nullable: true),
                    Sukupuoli = table.Column<string>(nullable: true),
                    KuvaUrl = table.Column<string>(nullable: true),
                    SyntymaAika = table.Column<DateTime>(nullable: false),
                    AloitusPvm = table.Column<DateTime>(nullable: false),
                    Tehtava = table.Column<string>(nullable: true),
                    Sahkoposti = table.Column<string>(nullable: true),
                    SosTurvaTunnus = table.Column<string>(maxLength: 50, nullable: false),
                    Maksutapa = table.Column<int>(nullable: false),
                    LiitonJasen = table.Column<int>(nullable: false),
                    Osoite = table.Column<string>(maxLength: 150, nullable: false),
                    Kaupunki = table.Column<string>(maxLength: 50, nullable: false),
                    Postinro = table.Column<string>(maxLength: 50, nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Henkilot", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Verotusvuosi = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    VerovuosiId = table.Column<int>(nullable: false),
